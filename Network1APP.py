...
if (len(selected_onus_acct)==0 and len(selected_offus_acct)==0):
  ...
  firstlayer_onus_acct = df_edge_firstlayer.loc[df_edge_firstlayer['Orig.Bank']=='on-us']['Orig'].drop_duplicates() +
                         df_edge_firstlayer.loc[df_edge_firstlayer['Dest.Bank']=='on-us']['Dest'].drop_duplicates()
