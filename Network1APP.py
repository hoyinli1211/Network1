...
if (len(selected_onus_acct)==0 and len(selected_offus_acct)==0):
  ...
  nx.set_node_attributes(G2, color_G2node, 'node_color')
  net2 = Network(height='465px', bgcolor='#222222', font_color='white', directed=True, node_color = [G2.nodes[n]['node_color'] for n in G2.nodes])
  net2.from_nx(G2)
